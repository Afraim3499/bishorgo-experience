...
interface Props {
  faqs: ServicePageBlueprint["faqs"];
}

export const ServiceFAQ: React.FC<Props> = ({ faqs }) => {
      ...
      <div className="max-w-[1320px] mx-auto px-5 md:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-[36%_64%] gap-12 lg:gap-20 items-start">
          ...
          >
            ...
            <p className="text-[14px] text-[#222222]/60 font-medium leading-relaxed mt-5 max-w-xs">
              Still have questions? Book an Experience Audit and we&apos;ll answer them in detail.
            </p>
            <a
