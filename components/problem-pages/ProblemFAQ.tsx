...
interface Props {
  faqs: ProblemPageBlueprint["faqs"];
  problemLabel: string;
}

export const ProblemFAQ: React.FC<Props> = ({ faqs, problemLabel }) => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[36%_64%] gap-12 lg:gap-20 items-start">
          ...
          >
            ...
            <p className="text-[14px] text-[#222222]/60 font-medium leading-relaxed mt-5 max-w-xs select-text">
              Still have questions about how we diagnose and solve {problemLabel.toLowerCase()} issues? Book an Experience Audit and let us examine your touchpoints.
            </p>
            <a
